...
- (NSArray<FUBeautySkinModel *> *)defaultSkins {
    ...
    NSString *skinPath = self.performanceLevel == FUDevicePerformanceLevelLow ? [bundle pathForResource:@"beauty_skin_low" ofType:@"json"] : [bundle pathForResource:@"beauty_skin" ofType:@"json"];
