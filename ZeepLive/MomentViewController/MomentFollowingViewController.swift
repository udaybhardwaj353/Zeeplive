//
//  MomentFollowingViewController.swift
//  ZeepLive
//
...
class MomentFollowingViewController: UIViewController {
...
extension MomentFollowingViewController: UITableViewDelegate, UITableViewDataSource, delegateMomentTableViewCell, delegateMomentCommentViewController {
...
//        cell.lblUserMessage.text = momentData.data?[indexPath.row].message
        ...
        cell.btnFollowUserOutlet.isHidden = true
        cell.btnOptionOutlet.isHidden = true
...
//        tblView.reloadRows(at: [indexPath], with: .none)
    ...
    func followButtonClicked(index: Int) {
        ...
        print("The follow button is pressed in moment following , and index is: \(index)")
    ...
    func imageClicked(type:String,index: Int) {
        print(type)
        print("The image index clicked in follow view controller is: \(index)")
        ...
        nextViewController.cameFrom = "following"
        self.navigationController?.pushViewController(nextViewController, animated: true)
...
// MARK: - EXTENSION FOR API CALLING FOR GETTING DATA FOR LISTING

extension MomentFollowingViewController {
...
// MARK: - EXTENSION FOR API CALLING FOR MOMENT LIKE AND UNLIKE WORK
