...
extension FollowViewController: ZegoEventHandler {
...
extension FollowViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if (usersList.data?[indexPath.item].userStatus == "0")  {
            ...
            nextViewController.apiType = "follow"
            self.navigationController?.pushViewController(nextViewController, animated: true)
...
extension FollowViewController: UICollectionViewDelegateFlowLayout, delegateHomeScreenUsersListCollectionViewCell {
...
extension FollowViewController {
    ...
    func getUsersFollowList() {
        
        let url = AllUrls.baseUrl + "livebroadcastList?type=followlive&page=\(pageNo)"
